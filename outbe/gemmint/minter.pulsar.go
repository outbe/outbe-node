...
func init() {
	...
	md_Minter = File_outbe_gemmint_minter_proto.Messages().ByName("Minter")
...
func (x *Minter) slowProtoReflect() protoreflect.Message {
	mi := &file_outbe_gemmint_minter_proto_msgTypes[0]
...
func (x *fastReflection_Minter) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "outbe.gemmint.Minter.inflation":
		return x.Inflation != ""
	case "outbe.gemmint.Minter.annual_provisions":
		return x.AnnualProvisions != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: outbe.gemmint.Minter"))
		}
		panic(fmt.Errorf("message outbe.gemmint.Minter does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Minter) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message outbe.gemmint.Minter does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Minter) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "outbe.gemmint.Minter.inflation":
		panic(fmt.Errorf("field inflation of message outbe.gemmint.Minter is not mutable"))
	case "outbe.gemmint.Minter.annual_provisions":
		panic(fmt.Errorf("field annual_provisions of message outbe.gemmint.Minter is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: outbe.gemmint.Minter"))
		}
...
func (x *fastReflection_Minter) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in outbe.gemmint.Minter", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Minter) Descriptor() ([]byte, []int) {
	return file_outbe_gemmint_minter_proto_rawDescGZIP(), []int{0}
}
...
var File_outbe_gemmint_minter_proto protoreflect.FileDescriptor

var file_outbe_gemmint_minter_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x6f, 0x75, 0x74, 0x62, 0x65, 0x2f, 0x67, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x74, 0x2f,
	0x6d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x6f, 0x75,
	...
	0xb9, 0x01, 0x0a, 0x06, 0x4d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x4f, 0x0a, 0x09, 0x69, 0x6e,
	...
	0x52, 0x09, 0x69, 0x6e, 0x66, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5e, 0x0a, 0x11, 0x61,
	...
	,
}

var (
	file_outbe_gemmint_minter_proto_rawDescOnce sync.Once
	file_outbe_gemmint_minter_proto_rawDescData = file_outbe_gemmint_minter_proto_rawDesc
)

func file_outbe_gemmint_minter_proto_rawDescGZIP() []byte {
	file_outbe_gemmint_minter_proto_rawDescOnce.Do(func() {
		file_outbe_gemmint_minter_proto_rawDescData = protoimpl.X.CompressGZIP(file_outbe_gemmint_minter_proto_rawDescData)
	})
	return file_outbe_gemmint_minter_proto_rawDescData
}

var file_outbe_gemmint_minter_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_outbe_gemmint_minter_proto_goTypes = []interface{}{
	(*Minter)(nil), // 0: outbe.gemmint.Minter
}
var file_outbe_gemmint_minter_proto_depIdxs = []int32{
...
func init() { file_outbe_gemmint_minter_proto_init() }
func file_outbe_gemmint_minter_proto_init() {
	if File_outbe_gemmint_minter_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_outbe_gemmint_minter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Minter); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_outbe_gemmint_minter_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_outbe_gemmint_minter_proto_goTypes,
		DependencyIndexes: file_outbe_gemmint_minter_proto_depIdxs,
		MessageInfos:      file_outbe_gemmint_minter_proto_msgTypes,
	}.Build()
	File_outbe_gemmint_minter_proto = out.File
	file_outbe_gemmint_minter_proto_rawDesc = nil
	file_outbe_gemmint_minter_proto_goTypes = nil
	file_outbe_gemmint_minter_proto_depIdxs = nil
}
