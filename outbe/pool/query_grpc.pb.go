...
const (
	Query_GetBlockEmission_FullMethodName = "/outbe.pool.Query/GetBlockEmission"
	Query_GetEmission_FullMethodName      = "/outbe.pool.Query/GetEmission"
	Query_GetTotalSupply_FullMethodName   = "/outbe.pool.Query/GetTotalSupply"
	Query_GetTribute_FullMethodName       = "/outbe.pool.Query/GetTribute"
)
