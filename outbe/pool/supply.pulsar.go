...
func init() {
	...
	md_Supply = File_outbe_pool_supply_proto.Messages().ByName("Supply")
...
func (x *Supply) slowProtoReflect() protoreflect.Message {
	mi := &file_outbe_pool_supply_proto_msgTypes[0]
...
func (x *fastReflection_Supply) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "outbe.pool.Supply.total_supply":
		return x.TotalSupply != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: outbe.pool.Supply"))
		}
		panic(fmt.Errorf("message outbe.pool.Supply does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Supply) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message outbe.pool.Supply does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Supply) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "outbe.pool.Supply.total_supply":
		panic(fmt.Errorf("field total_supply of message outbe.pool.Supply is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: outbe.pool.Supply"))
		}
...
func (x *fastReflection_Supply) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in outbe.pool.Supply", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Supply) Descriptor() ([]byte, []int) {
	return file_outbe_pool_supply_proto_rawDescGZIP(), []int{0}
}
...
var File_outbe_pool_supply_proto protoreflect.FileDescriptor

var file_outbe_pool_supply_proto_rawDesc = []byte{
	0x0a, 0x17, 0x6f, 0x75, 0x74, 0x62, 0x65, 0x2f, 0x70, 0x6f, 0x6f, 0x6c, 0x2f, 0x73, 0x75, 0x70,
	0x70, 0x6c, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x6f, 0x75, 0x74, 0x62, 0x65,
	...
	0x6c, 0x79, 0x42, 0x92, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x75, 0x74, 0x62, 0x65,
	...
	0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6f, 0x75, 0x74, 0x62, 0x65, 0x2f, 0x70, 0x6f, 0x6f, 0x6c,
	0xa2, 0x02, 0x03, 0x4f, 0x50, 0x58, 0xaa, 0x02, 0x0a, 0x4f, 0x75, 0x74, 0x62, 0x65, 0x2e, 0x50,
	0x6f, 0x6f, 0x6c, 0xca, 0x02, 0x0a, 0x4f, 0x75, 0x74, 0x62, 0x65, 0x5c, 0x50, 0x6f, 0x6f, 0x6c,
	0xe2, 0x02, 0x16, 0x4f, 0x75, 0x74, 0x62, 0x65, 0x5c, 0x50, 0x6f, 0x6f, 0x6c, 0x5c, 0x47, 0x50,
	0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0b, 0x4f, 0x75, 0x74, 0x62,
	0x65, 0x3a, 0x3a, 0x50, 0x6f, 0x6f, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_outbe_pool_supply_proto_rawDescOnce sync.Once
	file_outbe_pool_supply_proto_rawDescData = file_outbe_pool_supply_proto_rawDesc
)

func file_outbe_pool_supply_proto_rawDescGZIP() []byte {
	file_outbe_pool_supply_proto_rawDescOnce.Do(func() {
		file_outbe_pool_supply_proto_rawDescData = protoimpl.X.CompressGZIP(file_outbe_pool_supply_proto_rawDescData)
	})
	return file_outbe_pool_supply_proto_rawDescData
}

var file_outbe_pool_supply_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_outbe_pool_supply_proto_goTypes = []interface{}{
	(*Supply)(nil), // 0: outbe.pool.Supply
}
var file_outbe_pool_supply_proto_depIdxs = []int32{
...
func init() { file_outbe_pool_supply_proto_init() }
func file_outbe_pool_supply_proto_init() {
	if File_outbe_pool_supply_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_outbe_pool_supply_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Supply); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_outbe_pool_supply_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_outbe_pool_supply_proto_goTypes,
		DependencyIndexes: file_outbe_pool_supply_proto_depIdxs,
		MessageInfos:      file_outbe_pool_supply_proto_msgTypes,
	}.Build()
	File_outbe_pool_supply_proto = out.File
	file_outbe_pool_supply_proto_rawDesc = nil
	file_outbe_pool_supply_proto_goTypes = nil
	file_outbe_pool_supply_proto_depIdxs = nil
}
