...
func NewAppModule(module distribution.AppModule, keeper distributionkeeper.Keeper, accountKeeper gemdistributiontypes.AccountKeeper, bankKeeper gemdistributiontypes.BankKeeper, ss exported.Subspace, distributionkeeper distributionkeeper.Keeper, stakingKeeper stakingKeeper.Keeper, rewardKeeper rewardKeeper.Keeper, allocationpoolKeeper allocationpoolKeeper.Keeper, mintKeeper gemmintKeeper.Keeper, craKeeper craKeeper.Keeper) AppModule {
	wrappedBankKeeper := gemdistributionkeeper.NewWrappedBaseKeeper(keeper, accountKeeper, bankKeeper, stakingKeeper, rewardKeeper, allocationpoolKeeper, mintKeeper, craKeeper)
