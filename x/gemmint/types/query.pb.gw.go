...
var (
	filter_Query_Whitelist_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Query_Whitelist_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Query_Whitelist_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"outbe", "gemmint", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Inflation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"outbe", "gemmint", "inflation"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AnnualProvisions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"outbe", "gemmint", "annual_provisions"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Whitelist_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"outbe", "gemmint", "whitelist"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Minted_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"outbe", "gemmint", "minted"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Minters_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"outbe", "gemmint", "minters"}, "", runtime.AssumeColonVerbOpt(false)))
)
